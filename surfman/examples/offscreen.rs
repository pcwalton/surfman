...
impl TriProgram {
    fn new(gl_texture_target: GLenum) -> TriProgram {
        let vertex_shader = Shader::new("tri", ShaderKind::Vertex, gl_texture_target, &FilesystemResourceLoader);
        let fragment_shader = Shader::new("tri", ShaderKind::Fragment, gl_texture_target, &FilesystemResourceLoader);
